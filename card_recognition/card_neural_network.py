...
class CardNeuralNetwork():
    ...
    def create_test_images(self):
        ...
        dirs = [(r'PP_old/', r'/card_training/'),
                (r'SN/', r'/card_training/'),
                (r'PS/', r'/card_training/'),
                (r'PP/', r'/card_validating/'),
                (r'PP/', r'/card_testing/'),
    ...
    def prepare_data(self):
        ...
        validation_data_dir = dir_path + "/card_validating"
        test_data_dir = dir_path + "/card_testing"
